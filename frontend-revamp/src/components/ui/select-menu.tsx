...
const SelectMenuScrollUpButton = React.forwardRef<
...
SelectMenuScrollUpButton.displayName = SelectPrimitive.ScrollUpButton.displayName

const SelectMenuScrollDownButton = React.forwardRef<
...
SelectMenuScrollDownButton.displayName =
